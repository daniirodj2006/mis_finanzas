import{t as e}from"./rolldown-runtime-lhHHWwHU.js";import{i as t}from"./index.esm-Bswo4R-X.js";import{r as n,t as r}from"./firebase-DQl45onh.js";var i=e({renderLogin:()=>a});function a(){document.querySelector(`#main-content`).innerHTML=`
  ...
  `,document.querySelector(`#btn-google`).addEventListener(`click`,async()=>{try{await t(r,n)}catch(e){console.error(`Error al iniciar sesión:`,e)}})}export{a as n,i as t};